  ...
  const clearDataMutation = useMutation({
    mutationFn: async () => {
      ...
      await axios.delete('/api/admin/clear-data', {
        params: { municipio_id: currentMunicipality.id, modulo: 'secretarias', delete_storage: deleteStorage }
      });
    },
    onSuccess: () => {
      qc.invalidateQueries({ queryKey: ['secretarias'] });
        ...
        {confirmClear && (
          <div className="fixed inset-0 bg-slate-900/40 backdrop-blur-md z-[100] flex items-center justify-center p-6">
            ...
            >
              ...
              <h3 className="text-2xl font-black text-slate-900 mb-2">Limpar Secretarias</h3>
              <p className="text-slate-500 font-medium leading-relaxed mb-6">
                Esta ação apagará todas as secretarias cadastradas para <strong>{currentMunicipality?.name}</strong>.
              </p>
              ...
              >
                ...
                <span className="text-[13px] font-bold text-slate-600">Apagar também fotos do Storage</span>
              </div>
