...
- **Lion Lab Protocol:** For advanced safety/security, refer to modular rules in `.agent/rules/lion-lab/` based on the active domain (Security, Backend, or Infra).
...
- Maintain `README.md`, `ARQUITETURA.md`, `COMANDOS.md`, and `CHECKLIST_NOVO.md` updated.
- Use the `/init-docs` workflow to bootstrap these files in new projects.
